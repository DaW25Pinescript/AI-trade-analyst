...
- [ ] **P2 user documentation:** Create/extend user guide (ticket flow, navigation, dynamic updates, print/export, keyboard a11y).
- [ ] **P2 QA evidence:** Record quick manual QA notes (labels, keyboard focus, print preview) and exact changed-file list.
...
- [ ] Update `app/releases/README.md` for new milestone snapshot
