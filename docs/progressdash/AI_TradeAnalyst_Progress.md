...
| Date | Phase | Activity |
|------|-------|----------|
| 15 Mar 2026 | PR-OPS-4b | Delivered agent-detail endpoint — 72 new tests, all 25 spec ACs passing, 197 ops tests total |
| 15 Mar 2026 | PR-OPS-4a | Delivered agent-trace endpoint — 71 new tests, trace projection + audit log join, 126 ops tests |
| 14 Mar 2026 | PR-UI-6 | Journal & Review MVP shipped — decision readback, review toggle, 42 new tests, 243 total |
| 14 Mar 2026 | PR-UI-5 | Analysis Run MVP shipped — multipart /analyse, run lifecycle state machine, 69 new tests, 201 total |
| 14 Mar 2026 | PR-UI-4 | Journey Studio MVP shipped — staged flow, freeze lifecycle, bootstrap context, 43 new tests, 132 total |
| 13 Mar 2026 | PR-OPS-3 | Agent Ops workspace MVP — roster + health wiring, org view, 23 new tests, 89 total |
| 13 Mar 2026 | PR-OPS-1 | Agent Ops contract spec — endpoint contracts for roster + health, zero code changes |
| 13 Mar 2026 | PR-UI-3 | Shared component extraction — generic EntityRowCard, barrel exports, 36 new tests, 66 total |
| 13 Mar 2026 | PR-UI-2 | Triage Board MVP — live data, trust strip, 7 state conditions, 24 new tests, 30 total |
| 13 Mar 2026 | PR-UI-1 | React app shell — Vite + routing + typed fetch + TanStack Query, 5 smoke tests |
| 13 Mar 2026 | Phase 0 | UI re-entry governance — React + TS + Tailwind locked, execution plan committed |
| 13 Mar 2026 | Cleanup | Doc consolidation, async markers, TD-5/TD-9 micro-PRs |
| 12 Mar 2026 | Obs Phase 2 | Cross-lane structured event logging — 16 event codes, 18 new tests |
| 12 Mar 2026 | TD-3 | Packaging/import stability — 27 sys.path.insert removed, 16 import tests |
| 12 Mar 2026 | UI Phase 3A | Workspace blueprint + visual design — wireframes, component system, design notes |
| 12 Mar 2026 | UI Phase 2 | UI Contract — canonical frontend handoff locked |
| 12 Mar 2026 | UI Phase 1 | Backend capability audit — docs/ui/UI_BACKEND_AUDIT.md |

## Roadmap

Future phases and extensions beyond the current plan. These items are sequenced but not yet scheduled.

| Priority | Phase | Description | Status | Depends On |
|----------|-------|-------------|--------|------------|
| 1 | PR-OPS-5 | Frontend Agent Ops wiring — Run Mode + Health Mode + Detail Sidebar | 📋 Planned | PR-OPS-4 |
| 2 | UI Phase 3B | Backend capability exposure — Feeder, Ops, Analytics, optional streaming | 📋 Planned | Phase 6 |
| 3 | Chart Evidence Workspace | Visual chart evidence capture and annotation for trade analysis | 💭 Concept | UI Phase 3B |
| 4 | Run Artifact Inspector | Deep inspection of individual run artifacts, logs, and decision traces | 💭 Concept | UI Phase 3B |
| 5 | Reflective Intelligence Layer | Human-governed review and policy-refinement architecture on run-record audit trails | 💭 Concept | Agent Ops + Journal |
| 6 | Runtime Lane Convergence | Reduce architectural split between analyst, graph, MDO, and legacy lanes | 💭 Concept | Observability complete |
| 7 | Performance Optimisation | TD-6/TD-7 packet assembly decomposition + eager loading removal | 💭 Concept | Runtime convergence |
